...
const Input = ({ inputStyle, rightIconStyle, maxLength, multiline, value, label, placeholder, onChangeText, secureTextEntry, rightIcon, leftIcon, rightPress, containerStyle, visible, select, date, onSelect, keyboardType }) => {
